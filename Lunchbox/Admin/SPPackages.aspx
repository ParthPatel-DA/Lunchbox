<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="SPPackages.aspx.cs" Inherits="Admin_SPPackages" %>
                            ...
                            <asp:Repeater ID="rptViewDetail" runat="server">
                                <ItemTemplate>
                                    ...
                                    <div style="float: left; margin-left: 20px;">
                                        ...
                                        <h3>Name<asp:Label runat="server" Text=":" Style="padding: 68px;"></asp:Label>
                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("PN")  %>' Style="font-size: 15px; margin-left: -45px;"></asp:Label><br />
                                        </h3>

                                        <h3>Durastion<asp:Label runat="server" Text=":" Style="padding: 30px;"></asp:Label>
                                            <asp:Label ID="Label8" runat="server" Text='<%# Eval("Du") %>' Style="font-size: 15px; margin-left: -8px;"></asp:Label><br />
                                        </h3>

                                        <h3>Price<asp:Label runat="server" Text=":" Style="padding: 75px;"></asp:Label>
                                            <asp:Label ID="Label7" runat="server" Text='<%# Eval("Price") %>' Style="font-size: 15px; margin-left: -48px;"></asp:Label><br />
                                        </h3>
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Start_Date") %>' /></td>
                                        <td>
                                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("End_Date") %>' /></td>
