    <%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="SPform.aspx.cs" Inherits="form" %>
            ...
            <%--<form class="form" role="form" name="myform" action="http://takeurpick.com/login/new_signup" method="post">--%>
              ...
              <asp:Panel ID ="panel1" runat="server" Visible ="true" >
               ...
               <%--      <div id="checkArray">
                              ...
                              <div class="col-md-2 col-xs-6 col-sm-6"  style="margin-right: -5px">
                                <span >
                                    <asp:Label ID="lblveg" runat="server">
                         
                                  <asp:CheckBox ID="chkvege" runat="server"></asp:CheckBox> Veg</asp:Label>
                                </span>
                                       </div>

                              <div class="col-md-2 col-xs-6 col-sm-6" style="margin-right: -3px">
                                 <span >
                                     <asp:Label ID="lblnonveg" runat="server" >
                                     <asp:CheckBox id="chknonvege" runat="server"></asp:CheckBox>NonVeg                          
                                         </asp:Label>
                       </span>
                                      </div>
                              ...
                              <div class="col-md-2 col-xs-6 col-sm-6"  style="margin-right: -3px">
                             <span >
                                     <asp:Label Id="lblcombo" runat="server" style="margin-right: -5px" >
                                     <asp:CheckBox id="chkcombo" runat="server" ></asp:CheckBox>Both
                 ...
                 <a class="Meal Type" href="#">
                     <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i>Sign Up for Newsletter</label>
                      </a> --%>
                   
                  <%--<div class="wow fadeInRight" data-wow-delay="0.4s">						
                  <span>Meal/Menu Type</span>
                     								
                     <div class="radio">								
                        <label>	<asp:RadioButton ID="RadioButton1" runat="server" />Veg	</label>		
                     </div>
                     <div class="radio" style="margin-top:13px">								  
                        <label><asp:RadioButton ID="RadioButton2" runat="server" />Non-Veg	</label>				
                     </div>
                      <div class="radio" style="margin-top:13px">								  
                        <label><asp:RadioButton ID="RadioButton3" runat="server" />Both	</label>								
                     </div>
                  </div>--%>
               </div>
            ...
            <%--   <div class="col-md-6">
               <div class="clearfix"> </div> --%>
                     ...
                     <%--<input type="text" class="form-control"  name="company">	--%>
                      <asp:TextBox ID="txtcompnm" runat="server" required="required" pattern="[A-Za-z ]*" oninvalid="setCustomValidity('Enter Company in character format')" oninput="setCustomValidity('')" MaxLength="25" Class="form-control" Names="company"></asp:TextBox>						
                  </div>
                          <div class="wow fadeInRight" data-wow-delay="0.4s">
                ...
                <%--  <span>Meal/Menu Type</span>--%>
                     ...
                     <div class="radio">								
                        <label>	<asp:RadioButton ID="radveg" runat="server" GroupName="rad" />Veg	</label>		
                     </div>
                     <div class="radio" style="margin-top:13px">								  
                        <label><asp:RadioButton ID="radnonveg" runat="server" GroupName="rad" />Non-Veg	</label>				
                     </div>
                      <div class="radio" style="margin-top:13px">								  
                        <label><asp:RadioButton ID="radboth" runat="server" GroupName="rad" />Both	</label>								
                     </div>
                  </div>
                          <br />
                 <h3>YOUR PASSWORD</h3> 
                  <div class="wow fadeInLeft form-group" data-wow-delay="0.4s">
                     <%--<span>Password<label>*</label>--%>
                      ...
                      <asp:TextBox ID="txtpass" runat="server" required="required" pattern="^[A-Za-z0-9]+{5,15}$"  oninvalid="setCustomValidity('Enter minimum 5 and maximum 15 characters for password')" TextMode="password" oninput="setCustomValidity('')"   Class="form-control" Names="password" style="border: 1px solid #EEE;
                  ...
                  <div class="wow fadeInRight form-group" data-wow-delay="0.4s">
                     <span>
                      ...
                      <asp:TextBox ID="txtconpass" runat="server" required="required" pattern="^[A-Za-z0-9]+{5,15}$"  oninvalid="setCustomValidity('Enter minimum 5 and maximum 15 characters for password')" TextMode="password" oninput="setCustomValidity('')"  Class="form-control" Names="conpassword" style="border: 1px solid #EEE;
                        outline-color: #FF5B36;
                        width: 96%;
                        font-size: 1em;
                        padding: 0.5em;"></asp:TextBox>
                      <asp:Label ID="lblerrorPwd" runat="server" Text="Please Enter Same Password." style="color: #ff0000; font-weight: bolder;" Visible="false"></asp:Label>
                        ...
                        <asp:Button ID ="btnnext" runat="server" Text="Next" style=" margin-top: 1em; color: #fff; font-size: 1.3em; 
                                    padding: 0.4em 1em; -webkit-appearance: none; height: 45px; display: inline-block -moz-transition: all 0.3s ease-out; -ms-transition: all 0.3s ease-out; -o-transition: all 0.3s ease-out;
                                     transition: all 0.3s ease-out; font-weight: 600; border: none; text-transform: uppercase; 
                                     cursor: pointer; background: #E24426; " OnClick ="btnnext_Click"  ></asp:Button>
                          </div> 
            </asp:Panel>
               ...
               <div class="register-bottom-grid">
                  ...
                  <div class="wow fadeInRight form-group" data-wow-delay="0.4s">								
                     ...
                     <%--<textarea   class="form-control" name="address2" style="border: 1px solid #EEE;outline-color: #FF5B36;width: 96%;font-size: 1em;padding: 0.5em;"></textarea>							 --%>
                      <asp:TextBox ID="txtarea" required="required"   oninvalid="setCustomValidity('Enter the area in proper format')" oninput="setCustomValidity('')" runat="server" class="form-control"   style="border: 1px solid #EEE;outline-color: #FF5B36;width: 50%;font-size: 1em;padding: 0.5em;" name="address2" ></asp:TextBox>
                  </div>
				    <div class="wow fadeInRight form-group" data-wow-delay="0.4s">								
                     <span><%--Landmark--%>
                    ...
                    <%-- <textarea   class="form-control" name="landmark" style="border: 1px solid #EEE;outline-color: #FF5B36;width: 96%;font-size: 1em;padding: 0.5em;"></textarea>							 --%>
                        <asp:TextBox ID="txtlm" runat="server" required="required" pattern="[A-Za-z]{25}" oninvalid="setCustomValidity('Enter the landmark in proper format')" oninput="setCustomValidity('')" TextMode="MultiLine"  style="border: 1px solid #EEE;outline-color: #FF5B36;width: 50%;font-size: 1em;padding: 0.5em;" name="Landmark" ></asp:TextBox>   
                    </div>
                  <div class="wow fadeInRight" data-wow-delay="0.4s">								
...
<%--                     <input type="text" class="form-control"  name="postal_code"  required />							--%>
                ...
                <asp:LinkButton ID ="lnkmylink" runat="server" ></asp:LinkButton>
                   ...
                   <div>
                    <asp:Button ID="btnsub" runat="server" Text="Submit" style=" margin-top: 1em; color: #fff; font-size: 1.3em; 
                                 padding: 0.4em 1em; -webkit-appearance: none; height: 45px; display: inline-block; 
                                 -moz-transition: all 0.3s ease-out; -ms-transition: all 0.3s ease-out; -o-transition: all 0.3s ease-out; 
                                 transition: all 0.3s ease-out; font-weight: 600; border: none; text-transform: uppercase;
                                  cursor: pointer; background: #E24426; " OnClick ="btnsub_Click" />
									 </div>
               </div>
