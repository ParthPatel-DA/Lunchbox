...
clone.remove()
clone2.remove()}})})},zoomer:function(el,last){if(_.slideshow)_.slideshow=_.duration-2000
...
if(_.pagination&&_.pagination!==true&&_.pagination.data&&_.pagination.data('uCarousel'))_.pagination.uCarousel(n)
...
var _fu=function(){if($.browser.msie&&$.browser.version<9&&_.preset=='zoomer')_.preset='simpleFade',_.duration=1000
...
if(_.preset=='random')$.extend(_,_.presets[_.prsts[parseInt(Math.random()*_.prsts.length)]]),_.reverseWay=[true,false][parseInt(Math.random()*2)]
_.sliceFu()
...
if(_.banners!==false)_.banner=_.bnnrs[_.n]
if(_.banner)$.when($('.'+_.bannerCl,_.me)).then(function(){$('.'+_.bannerCl,_.me).not(_.banner).remove()}),_.banner.appendTo(_.me),_.bannerShow(_.banner,_)
_.afterAnimation()
...
_.bannerShow(_.banner=_.bnnrs[_.show].appendTo(_.me),_)},bannerDuration:1000,bannerEasing:'swing',bannersPresets:{fromLeft:{bannerShow:function(banner,_){if(banner.css('top')=='auto')banner.css('top',0)
