<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="privacy_policy.aspx.cs" Inherits="privacy_policy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="order-section-page">
        <div class="ordering-form" style="background: #FFFFFF;">
            <div class="container">
                ...
                <div class="col-md-12 order-form-grids">
                    ...
                    <div class="order-form-grid  wow fadeInLeft" data-wow-delay="0.4s">
                        <h5 style="font-size: 2.2em">Privacy Policy</h5>
                        <p>
                            This policy explains how we, TakeUrPick, use your personal information which you provide to us when using our service, including but not limited to our website.
                    ...
                    <div class="order-form-grid  wow fadeInLeft" data-wow-delay="0.4s">
                        <h5>Cookies and Google Analytics</h5>
                        <p>
                            Cookies are small text files that are placed on your computer by websites that you visit. They are widely used in order to make websites work, or work more efficiently, as well as to provide information to the owners of the site.<br>
                            <br>
                    ...
                    <div class="order-form-grid  wow fadeInLeft" data-wow-delay="0.4s">
                        <h5>How will we use the information we collect from you?</h5>
                        <p>
...
From time to time we may send your information to third parties which we consider may have goods or services which are of interest to you. If you do not wish to be contacted by third parties please email us at <a href="lunchboxindia2017@gmail.com" style="color: #E24425;" target="_blank">lunchboxindia2017@gmail.com</a>. 
                    ...
                    <div class="order-form-grid  wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <p>
                            You have a right to request a copy of the information we hold on you at any time. Please email us if you would like to receive a copy of this information at <a href="lunchboxindia2017@gmail.com" style="color: #E24425;" target="_blank">lunchboxindia2017@gmail.com</a>. 
