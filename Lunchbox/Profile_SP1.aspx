<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_SP1.aspx.cs" Inherits="Profile_SP" ValidateRequest="false" EnableEventValidation="false" %>
...
<%--                    <div class="col-md-11" style="border: 1px solid #aeaeae; border-radius: 5px; height: 200px; margin-top: 20px;">
                        ...
                        <div class="col-md-12" style="padding: 20px 5px 20px 5px; border: 0px solid #aeaeae; border-radius: 5px; color: #5b5b5b;">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12" style="border: 0px solid; padding: 0px; box-shadow: 0px 0px 4px #aeaeae;">
                                    <div class="col-md-12" style="border: 1px solid #CA1A1A; border-bottom: 0px; font-size: 17px; border-radius: 5px 5px 0px 0px; padding: 0px; background-color: #CA1A1A; font-weight: bolder; color: #fff;">
                                    ...
                                    <asp:Repeater ID="rptTodayMealOrder" runat="server" OnItemCommand="rptTodayMealOrder_ItemCommand">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkOrderRecord" runat="server" Style="color: #5b5b5b;" CommandName="ShowOrderDetail" CommandArgument='<%# Eval("OrderID") %>'>
                                                <div class="col-md-12" style="border: 1px solid; border-width: 0px 1px 1px 1px; font-size: 17px; padding: 0px;">
                                ...
                                <div class="col-md-4" style="margin-bottom: 30px;">
                                    <div class="col-md-12 MealBox">
                                        <div style="/*background: url(../mainimg/main7.jpg) no-repeat; */ background-color: #ca1a1a; height: 110px; width: 100%;">
                                            ...
                                            <abbr title="Submit Changes" style="background-color: #5b5b5b; color: #CA1A1A;">
                                                <asp:Button ID="lnkEditItem" runat="server" class="pull-right glyphicon glyphicon-ok" Style="color: #fff; font-size: 20px; margin: 10px; background-color: transparent; border: 0px solid; margin-top: 7px;" CommandName="EditItem" CommandArgument='<%# Eval("MealID") %>' Visible="false" Text="Edit" /></abbr>
                                            <asp:HiddenField ID="hdnImageID" runat="server" Value='<%# Eval("ImageID") %>' />
                                    ...
                                    <form method="post">
                                        <div class="col-md-12" style="margin-bottom: 40px;">
                                            <div class="col-md-12 MealBox">
                                                ...
                                                <abbr title="Submit Changes" style="background-color: #5b5b5b; color: #CA1A1A;">
                                                    <asp:Button ID="lnkEditItem" class="pull-right glyphicon glyphicon-ok" runat="server" Text="Edit" Style="color: #fff; background-color: transparent; font-size: 20px; margin: 10px; margin-top: 7px; border: 0px solid;" CommandName="EditMenu" CommandArgument='<%# Eval("MenuID") %>' Visible="false" />
                                                </abbr>
                ...
                <div id="divProfile" runat="server" class="col-md-9" style="padding: 0px 60px 20px 0px;" visible="false">
                    <div class="col-md-12" style="margin-top: 80px; font-size: 16px; color: #5b5b5b;">
                        ...
                        <%--<asp:LinkButton ID="LinkButton2" runat="server" Style="text-decoration: none; font-size: 35px; color: #373737; margin-left: 10px;"><div style="width: 100%;">Overview<span class="glyphicon glyphicon-edit" style="float: right; font-size: 25px; margin-top: 15px; margin-right: 5px;"></span></div></asp:LinkButton><hr style="margin-top: 5px; border: 1px solid #808080;" />
                        <div style="padding-left: 20px;">
                            <div class="col-md-4">
                                <h4 style="padding: 5px;">Company Name</h4>
                                <h4 style="padding: 5px;">Name</h4>
                            </div>
                            <div class="col-md-1">
                                <h4 style="padding: 5px;">:</h4>
                                <h4 style="padding: 5px;">:</h4>
                            </div>
                            <div class="col-md-7">
                                <h4></h4>
                    ...
                    <asp:LinkButton ID="LinkButton3" runat="server" Style="text-decoration: none; font-size: 35px; color: #373737; margin-left: 10px;"><div style="width: 100%;">Contact Info<span class="glyphicon glyphicon-edit" style="float: right; font-size: 25px; margin-top: 15px; margin-right: 5px;"></span></div></asp:LinkButton><hr style="margin-top: 5px; border: 1px solid #808080;" />
                    <div style="padding-left: 20px;">
                        <div class="col-md-4">
                            <h4 style="padding: 5px;">Email ID</h4>
                            <h4 style="padding: 5px;">Contact No</h4>
                            <h4 style="padding: 5px;"></h4>
                            <h4 style="padding: 5px;"></h4>
                        </div>
                        <div class="col-md-1">
                    ...
                    <asp:LinkButton ID="LinkButton4" runat="server" Style="text-decoration: none; font-size: 35px; color: #373737; margin-left: 10px;"><div style="width: 100%;">Location Info<span class="glyphicon glyphicon-edit" style="float: right; font-size: 25px; margin-top: 15px; margin-right: 5px;"></span></div></asp:LinkButton><hr style="margin-top: 5px; border: 1px solid #808080;" />
                    <div style="padding-left: 20px;">
                        <div class="col-md-4">
                            <h4 style="padding: 5px;">Address</h4>
                            <h4 style="padding: 5px; color: #fff;">:</h4>
                            <h4 style="padding: 5px; color: #fff;">:</h4>
                            <h4 style="padding: 5px; color: #fff;">:</h4>
                            <h4 style="padding: 5px; color: #fff;">:</h4>
                            <h4 style="padding: 5px; color: #fff;">:</h4>
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-12" style="border: 0px solid; padding: 0px; box-shadow: 0px 0px 4px #aeaeae;">
                                                ...
                                                <div class="col-md-12" style="border: 1px solid #CA1A1A; border-bottom: 0px; font-size: 17px; border-radius: 5px 5px 0px 0px; padding: 0px; background-color: #CA1A1A; color: #fff; font-weight: bolder;">
                                                    <div class="col-md-3 text-center" style="padding: 10px; border-right: 1px solid #CA1A1A;">Meal Name</div>
                                                    <div class="col-md-2 text-center" style="padding: 10px; border-right: 1px solid #CA1A1A;">Time</div>
                                                    <div class="col-md-3 text-center" style="padding: 10px; border-right: 1px solid #CA1A1A;">Price</div>
                                                    <div class="col-md-2 text-center" style="padding: 10px; border-right: 1px solid #CA1A1A;">Quentity</div>
